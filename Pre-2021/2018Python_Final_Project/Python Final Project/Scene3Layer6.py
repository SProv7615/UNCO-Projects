...
#   Define a class called ForestStripe6
class ForestStripe6:
    ...
    def __init__ (self, canvas, name="Trees6"):
    ...
    def drawL6Trees(self, x, y):
        ...
        for tree in range(1, 20):
            ...
            yLoc = random.randint(self.L6middle, self.L6middle + 200)
    ...
    def moveDown(self, dist, prevDelay=0, afterDelay=0):
        ...
        if self.L6middle > 800:
            self.c.delete(self.name)
            yLoc=-400
            xLoc=400
            self.drawL6Trees(xLoc, yLoc)
