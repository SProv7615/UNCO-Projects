...
#   Define a class called ForestStripe
class ForestStripe5:
    ...
    def __init__ (self, canvas, name="Trees5"):
    ...
    def drawL5Trees(self, x, y):
        ...
        for tree in range(1, 20):
            ...
            yLoc = random.randint(self.L5middle, self.L5middle + 200)
    ...
    def moveDown(self, dist, prevDelay=0, afterDelay=0):
        ...
        if self.L5middle > 800:
            self.c.delete(self.name)
            yLoc=-400
            xLoc=400
            self.drawL5Trees(xLoc, yLoc)
