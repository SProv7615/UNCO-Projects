...
#   Define a class called ForestStripe1
class ForestStripe1:
    ...
    def __init__ (self, canvas, name="Trees1"):
    ...
    def drawL1Trees(self, x, y):
        ...
        for tree in range(1, 20):
            ...
            yLoc = random.randint(self.L1middle, self.L1middle + 200)
    ...
    def moveDown(self, dist, prevDelay=0, afterDelay=0):
        ...
        if self.L1middle > 800:
            self.c.delete(self.name)
            yLoc=-400
            xLoc=400
            self.drawL1Trees(xLoc, yLoc)
