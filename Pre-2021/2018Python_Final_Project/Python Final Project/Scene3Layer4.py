...
class ForestStripe4:
    ...
    def __init__ (self, canvas, name="Trees4"):
    ...
    def drawL4Trees(self, x, y):
        ...
        for tree in range(1, 20):
            ...
            yLoc = random.randint(self.L4middle, self.L4middle + 200)
