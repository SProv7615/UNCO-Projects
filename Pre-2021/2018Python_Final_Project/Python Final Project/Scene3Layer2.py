...
#   Define a class called ForestStripe2
class ForestStripe2:
    ...
    def __init__ (self, canvas, name="Trees2"):
    ...
    def drawL2Trees(self, x, y):
        ...
        for tree in range(1, 20):
            ...
            yLoc = random.randint(self.L2middle, self.L2middle + 200)
    ...
    def moveDown(self, dist, prevDelay=0, afterDelay=0):
        ...
        if self.L2middle > 800:
            self.c.delete(self.name)
            yLoc=-400
            xLoc=400
            self.drawL2Trees(xLoc, yLoc)
